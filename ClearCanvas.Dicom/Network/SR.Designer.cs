...
namespace ClearCanvas.Dicom.Network {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   查找类似 The message was not understood. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 A duplicate SOP Instance could not be processed. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Some instances of this study are not supported by the remote application. See log for more details. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Unexpected failure reported by the printer. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 A failure occurred due to a missing DICOM attribute. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The remote server is out of resources. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 A failure occurred while processing. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Retrieve failed due to the remote application not being able to reach your computer, possibly due to misconfiguration. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The remote server was unable to process the request. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The hostname was not found. 的本地化字符串。
        /// </summary>
