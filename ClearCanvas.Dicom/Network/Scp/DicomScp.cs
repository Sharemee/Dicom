...
namespace ClearCanvas.Dicom.Network.Scp
{
    ...
    /// </para>
    /// <para>
    /// The class depends on an <see cref="ExtensionPoint"/> for handling action DICOM services.
    /// The class will load plugins that implement the <see cref="IDicomScp{TContext}"/> interface.
    ...
    public class DicomScp<TContext>
    {
        ...
        /// </summary>
        public ServerAssociationParameters AssociationParameters => _assocParameters;
