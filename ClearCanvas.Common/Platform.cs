...
namespace ClearCanvas.Common
{
    ...
    public static class Platform
    {
        ...
        private static ILog GetLog(string name)
        {
            ...
            {
                //ILog log;
                if (!_namedLogs.TryGetValue(name, out ILog log))
                {
        ...
        /// <remarks>
        /// Use for checking if an input argument is <b>null</b>.  To check if a member variable
        /// is <b>null</b> (i.e., to see if an object is in a valid state), use <see cref="CheckMemberIsSet(object,string)"/> instead.
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="variable"/> or <paramref name="variableName"/> is <b>null</b>.
        /// </exception>
